...
export default function App() {
  ...
  const emailToCheck = userInput.toLowerCase()


  //check if the email is a duplicate
  const isDublicate = emailList.some(email => email.toLowerCase() === emailToCheck)
  ...
  /* Challenge
    ...
    Kullanıcı "Abone Ol" butonuna tıkladığında hiçbir şey olmuyor. Sizin göreviniz bu görevleri tamamlayarak kayıt formunun çalışmasını sağlamaktır: 
        ...
        3. Yukarıdakileri doğru bir şekilde yapıp "Abone Ol" butonuna tıklarsanız, input'un placeholder metninin 
        " Arkadaşınızı abone yapın" haline geldiğini ve başka bir email adresi girip onu da kontrol edebildiğinizi görmelisiniz.
 */
